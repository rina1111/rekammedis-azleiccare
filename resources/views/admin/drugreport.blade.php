...
<li>
      ...
      <li class="nav-item"  style="font-size:12px; ">
        <a  class="nav-link active" href="{{url('admin/drugreport')}}">Drug Report</a>
      </li>
      <li class="nav-item" style="font-size:12px;">
    ...
    <table class="table table-bordered" style="font-size:10px;">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{{$data->ket}}</td>
            <td>@if($data->gambar)
                <img src="{{asset('storage/'.$data->gambar)}}" width="70px"/>
                @else
                N/A
                @endif
          </td>
          <td>@if($data->status==0)<button type="button"  class="btn btn-success btn-sm" data-toggle="modal" data-target="#editstatus" name="button"><i class="fas fa-check"></i> Ready Stock </button>
               @else ($data->status==1)<button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#editstatus" name="button"><i class="fas fa-times"></i> Out of Stock </button>@endif</td>
